...
INSERT INTO geo.Dziesiec VALUES (0, 00000000);
INSERT INTO geo.Dziesiec VALUES (1, 00000001);
INSERT INTO geo.Dziesiec VALUES (2, 00000010);
INSERT INTO geo.Dziesiec VALUES (3, 00000011);
INSERT INTO geo.Dziesiec VALUES (4, 00000100);
INSERT INTO geo.Dziesiec VALUES (5, 00000101);
INSERT INTO geo.Dziesiec VALUES (6, 00000110);
INSERT INTO geo.Dziesiec VALUES (7, 00000111);
INSERT INTO geo.Dziesiec VALUES (8, 00001000);
INSERT INTO geo.Dziesiec VALUES (9, 00001001);
...
FROM geo.Dziesiec a1, geo.Dziesiec a2, geo.Dziesiec a3, geo.Dziesiec a4, geo.Dziesiec a5, geo.Dziesiec 
a6 
...
(MOD(geo.Milion.liczba,68)=(geo.GeoTabela.id_pietro));

#Zapytanie 2 (2 ZL)

SELECT COUNT(*) FROM geo.Milion INNER JOIN geo.GeoPietro ON 
(MOD(geo.Milion.liczba,68)=geo.GeoPietro.id_pietro) NATURAL JOIN geo.GeoEpoka NATURAL JOIN 
...
(SELECT id_pietro FROM geo.GeoTabela WHERE MOD(geo.Milion.liczba,68)=(id_pietro));
